...
if(isset($_SESSION['username'])){
	...
	{
        $nama_depan=ucwords(strtolower($_POST['nama_depan']));
		mysqli_query($koneksi,"INSERT INTO login_user (`id`, `nama_depan`, `nama_belakang`, `email`,`tipe_identitas`,`no_identitas`, `no_telepon`,`no_rek`,`nama_rek`, `alamat`, `username`, `password`, `level`) VALUES ( '$_POST[nama_depan]', '$_POST[nama_belakang]', '$_POST[email]', '$_POST[tipe_identitas]', '$_POST[no_identitas]','$_POST[no_telepon]','$_POST[no_rek]', '$_POST[nama_rek]', '$_POST[alamat]', '$_POST[username]', '$_POST[password]', '$_POST[level]')")
				or die(mysqli_error());
	}
	...
	{
        $nama_depan=ucwords(strtolower($_POST['nama_depan']));
		mysqli_query($koneksi,"UPDATE login_user SET nama_depan='$_POST[nama_depan]', nama_belakang='$_POST[nama_belakang]', email='$_POST[email]',tipe_identitas='$_POST[tipe_identitas]',no_identitas='$_POST[no_identitas]', no_telepon='$_POST[no_telepon]',no_rek='$_POST[no_rek]', nama_rek='$_POST[nama_rek]', alamat='$_POST[alamat]', username='$_POST[username]', password='$_POST[password]', level='$_POST[level]' WHERE id='$id'");
       ...
       <div class="panel panel-default">
           ...
           <div class="panel-body  ">
               <div class="row col-lg-10">
                 <form name="coba" action="coba.php" method="post" enctype="multipart/form-data">
                 <?php
								if (isset($_GET['id']))
								{
                           ...
                           <fieldset>
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="nama_depan" type="text" value="<?php echo $ngisi['nama_depan']; ?>" >
                                </div>
                                <div class="form-group">
                                    <label>Nama Belakang</label>
                                    <input class="form-control" name="nama_belakang" type="text" value="<?php echo $ngisi['nama_belakang']; ?>" >
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                    <input class="form-control" name="email" type="text" value="<?php echo $ngisi['email']; ?>" >
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="no_identitas" type="text" value="<?php echo $ngisi['no_idenntitas']; ?>" >
                                </div>
                                <div class="form-group">
                                    <label>Nomer Telepon</label>
                                    <input class="form-control" name="no_telepon" type="text" value="<?php echo $ngisi['no_telepon']; ?>" >
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="alamat" type="text" value="<?php echo $ngisi['alamat']; ?>" >
                                </div>
                                <div class="form-group">
           ...
           <div class="panel-body">
                        <div class="row col-lg-13">
                        	...
                        	<table class="table table-hover table-striped" id="dataTables-dataCustomer">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left">Passowrd</th>
                                ...
                                <tbody>
                                <?php
                                    $comot=mysqli_query($koneksi,"SELECT * FROM login_user");
                                    while($isi_tbl=mysqli_fetch_array($comot))
                                    {
                                ?>
                                    <tr>
                                        <td><?php echo $isi_tbl['id'] ?></td>
                                        <td><div class="tooltip-demo"><span data-toggle="tooltip" data-placement="top" title="[<?php echo $isi_tbl['tipe_identitas']; ?>] <?php echo $isi_tbl['no_identitas']; ?>">
										<?php echo $isi_tbl['nama_depan']; ?>  <?php echo $isi_tbl['nama_belakang'] ?></span>
										</div></td>
                                        <td><?php echo $isi_tbl['email']; ?></td>
                                        <td><?php echo $isi_tbl['no_telepon']; ?></td>
                                        <td><?php echo $isi_tbl['no_rek']; ?> a/n <?php echo $isi_tbl['nama_rek']; ?></td>
                                        <td><?php echo $isi_tbl['alamat']; ?></td>
                                        <td><?php echo $isi_tbl['username']; ?></td>
                                        <td><?php echo $isi_tbl['password']; ?></td>
                                        <td><?php echo $isi_tbl['level']; ?></td>
                                        <td>
                                        <div class="tooltip-demo">
                                            <a href="coba.php?id=<?php echo $isi_tbl[0]; ?>"><button type="button" class="btn btn-xs btn-primary" data-toggle="tooltip" data-placement="top" title="Edit Member"><i class="fa fa-wrench"></i></button></a>

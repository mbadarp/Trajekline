<?php 
    ...
    if (isset($_POST['update'])) {
        ...
        $query = "UPDATE data_request SET nama_lengkap='$nama_lengkap',email='$email',kota_tujuan='$kota_tujuan', jumlah_orang='$jumlah_orang', lama_hari='$lama_hari', tgl_berangkat='$tgl_berangkat', tujuan_wisata='$tujuan_wisata', tiket='$tiket', penginapan='$penginapan', fasilitas='$fasilitas' WHERE id_request='$id_request'";

...
?>
    ...
    <div class="container" id="datadiri">
            <div class="span6">
                <legend><p><h3><?php echo $tampil['nama_depan']; ?>   <?php echo $tampil['nama_belakang'] ?></h3></p></legend>
            </div>
			<div class="span6">
                <table class="table striped hovered">
                	<tbody>
						...
						<tr>
                            ...
                            <th class="text-left">[<?php echo $tampil['tipe_identitas']; ?>] <?php echo $tampil['no_identitas']; ?></th>
                        </tr>
						<tr>
                        	<th class="text-left">Telpon/Handphone</th>
                            <th class="text-left"><em><?php echo $tampil['no_telepon']; ?></em></th>
                        </tr>
						<tr>
